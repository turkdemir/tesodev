...
export class Content extends Component {
  render() {
    const filteredItems = this.props.filtered;
    ...
    return (
      <div className="container p-3" style={{ width: "700px", margin:"0 auto", }}>
        ...
        <table className="table table-hover table-sm" style={{ width: "100%", height:"600px"}}>
          <thead>
            <tr>
          ...
          <tbody>
            {filteredItems && filteredItems.map((element, index) => {
              return (
                <tr key={index}>
